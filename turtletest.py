...
def setup():
	...
	print(len(pos))
def cleargrid():
	for activeturtle in activeturtles:
		activeturtle['object'].hideturtle()
	activeturtles.clear()
	occupiedspace.clear()
...
if __name__ == "__main__":
    ...
    spawnbutton = tk.Button(canvas.master, text="Randomly Spawn", command=randomspawn)
    clearbutton = tk.Button(canvas.master, text="Clear Grid", command = cleargrid)
