...
def updategraph(generationnumber):
    ...
    if (1.0 * sum([snake.get_mimicry() for snake in list_of_king_snakes])/len(list_of_king_snakes)) > 0:
        mimictracer.goto(mimiclastposition + xincrement, mimicgraphorigin[1] + (1.0 * sum([snake.get_mimicry() for snake in list_of_king_snakes])/len(list_of_king_snakes))*3.5)
    else:
...
if __name__ == "__main__":
    ...
    messagelabel = tk.Label (canvas.master, text = 'Console:', font=("Arial",16))
    systemmessage = tk.Label (canvas.master, textvariable =message,font=("Arial",14), bg='white')
    statelabel = tk.Label (canvas.master, textvariable = statetext, font=("Arial",16))
    simulationstate = tk.Label (canvas.master, textvariable =state, bg = 'white',font=("Arial",14))
    mimicrylabel = tk.Label (canvas.master, text = 'Average Kingsnake Color', font=("Arial",16))
    graphtitle = tk.Label (canvas.master, text = 'Populations of Each Species',font=("Arial",16))
    yaxislabel = tk.Label (canvas.master, text = 'Qty.\n (y)',bg='white')
    xaxislabel = tk.Label (canvas.master, text = 'Generations (x)',font=("Arial",12),bg='white')
    cspopdisplay = tk.Label (canvas.master, textvariable = cspop, font=("Arial",12),bg='white')
    kspopdisplay = tk.Label (canvas.master, textvariable = kspop, font=("Arial",12),bg='white')
    bfpopdisplay = tk.Label (canvas.master, textvariable = bfpop, font=("Arial",12), bg='white')
    generationdisplay = tk.Label (canvas.master, textvariable = generation, font=("Arial",12),bg='white')
    cspoplabel = tk.Label (canvas.master, text= '# of Coral Snakes:', font=("Arial",12))
    kspoplabel = tk.Label (canvas.master, text = '# of King Snakes:', font=("Arial",12))
    bfpoplabel = tk.Label (canvas.master, text= '# of Bull Frogs:',font=("Arial",12))
    generationlabel = tk.Label (canvas.master, text ='Generation:',font=("Arial",12))
    ygraphlabel1 = tk.Label (canvas.master, text = '350', bg = 'white', font=("Arial",16))
    ygraphlabel2 = tk.Label (canvas.master, text = '0', bg = 'white', font=("Arial",16))
    xgraphlabel = tk.Label (canvas.master, textvariable = maxgeneration, bg ='white', font=("Arial",16))
    mimicrytext = tk.Label (canvas.master, textvariable = mimicry, bg = 'white', font=("Arial", 12))
    mimicrylabelnum  = tk.Label (canvas.master, text = 'Color Pattern Match \n\n (R, G, B)', font=("Arial",12))
    mimicgraphlabel = tk.Label (canvas.master, text = 'Pattern Match in King Snakes (y)',font=("Arial",16))
    ymimicgraphlabel1 = tk.Label (canvas.master, text = '100', bg='white',font=("Arial",16))
    ymimicgraphlabel2 = tk.Label (canvas.master, text = '0', bg ='white',font=("Arial",16))
    xmimicgraphlabel = tk.Label (canvas.master, textvariable = maxgeneration, bg ='white',font=("Arial",16))
    mimicxaxislabel = tk.Label (canvas.master, text = 'Generations (x)',font=("Arial",12),bg='white')

    coralsnake_input = tk.Scale(canvas.master, from_ = 0, to = 200, orient=HORIZONTAL, length = 300, label = 'Coral Snakes', font=("Arial",14))
    kingsnake_input = tk.Scale(canvas.master, from_ = 0, to = 200, orient=HORIZONTAL, length = 300, label = 'King Snakes',font=("Arial",14))
    bullfrog_input = tk.Scale(canvas.master, from_= 0, to = 200, orient=HORIZONTAL, length = 300, label = 'Bull Frogs',font=("Arial",14))
    generations_input = tk.Scale(canvas.master, from_= 0, to = 300, orient=HORIZONTAL, length = 300, label = 'Generations',font=("Arial",14))
    spawnbutton = tk.Button(canvas.master, text='Start', command = startsimulation,font=("Arial",16), bg="#4aa85d")
    clearbutton = tk.Button(canvas.master, text='Reset', command = cleargrid,font=("Arial",16), bg='#f2495a')


    makemodule(1.3, .2, messagelabel)
    makemodule(1.3, .6, systemmessage)
    makemodule(1, 1.3, simulationstate)
    makemodule(2.5, 1.3, statelabel)
